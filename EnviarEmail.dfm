object FEnviareMail: TFEnviareMail
  ...
  object barMgr: TdxBarManager
    ...
    Categories.Visibles = (
      True)
    ImageOptions.DisabledImages = FDMSrd.Img32_Main
    ImageOptions.DisabledLargeImages = FDMSrd.Img32_Main
    ImageOptions.HotImages = FDMSrd.Img32_Main
    ImageOptions.Images = FDMSrd.Img32_Main
    ImageOptions.LargeImages = FDMSrd.Img32_Main
    PopupMenuLinks = <>
    UseSystemFont = True
    Left = 384
    Top = 48
