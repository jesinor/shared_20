...
//    FIni := TIniFile.create( extractFilePath(application.ExeName) + 'conf\email.ini' );
    try
        ...
        visor.Report.EmailSettings.HostAddress := FIni.ReadString('EMAIL', 'host', 'mail.servidor.com.ar' );
        visor.Report.EmailSettings.UserName := FIni.ReadString('EMAIL', 'usu', 'usu@servidor.com.ar' );
        visor.Report.EmailSettings.Password := FIni.ReadString('EMAIL', 'password', 'password' );
        visor.Report.EmailSettings.FromName := FIni.ReadString('EMAIL', 'name', 'usu' );
        visor.Report.EmailSettings.FromAddress := FIni.ReadString('EMAIL', 'from', 'usu@servidor.com.ar' );
        ...
        // visor.Report.EmailSettings.ShowEmailDialog := true;
